...
from utils.load_model import model_code_to_cmodel_name, model_code_to_qmodel_name
...
result_output = f'{args.result_output}/{args.dataset}/{args.model_code}/beir.json'
...
retriever = EvaluateRetrieval(model, score_function=args.score_function, k_values=[50, 1000]) # "cos_sim"  or "dot" for dot-product
